		...
		<div className="h-full relative">
			...
			<div className="ml-8 h-full relative">
				<svg width="100%" height="100%" className="overflow-visible">
					...
					<line x1="0" y1="0%" x2="100%" y2="0%" stroke="rgba(100, 116, 139, 0.2)" />
					<line x1="0" y1="50%" x2="100%" y2="50%" stroke="rgba(100, 116, 139, 0.2)" />
					<line x1="0" y1="100%" x2="100%" y2="100%" stroke="rgba(100, 116, 139, 0.2)" />
	...
	return (
		<div className="space-y-6">
			...
			<div className="bg-slate-900 p-4 rounded-lg">
				...
				<div className="text-2xl font-bold text-emerald-400">{throughput.toFixed(1)} Mbps</div>
			...
			<div className="bg-slate-900 p-4 rounded-lg">
				...
				<div className="text-2xl font-bold text-blue-400">{latency.toFixed(1)} ms</div>
				{/* No graph displayed here */}
			</div>
			...
			<div className="bg-slate-900 p-4 rounded-lg">
				...
				<div className="text-2xl font-bold text-yellow-400">{packetLoss.toFixed(2)}%</div>
				{/* No graph displayed here */}
			</div>
			...
			<div className="bg-slate-900 p-4 rounded-lg">
				...
				<div className="text-2xl font-bold text-purple-400">{userConnectivity.toFixed(1)}%</div>
				{/* No graph displayed here */}
			</div>
		</div>
	);
						...
						{rightSidebarOpen && (
							<div className="h-full flex flex-col">
								...
								<div className="p-4 border-b border-slate-700 flex items-center justify-between bg-slate-800 sticky top-0 z-10">
									...
									<button className="text-slate-400 hover:text-white" onClick={() => setRightSidebarOpen(false)}>
										<X size={18} />
									</button>
								</div>
				...
				>
					...
					>
						...
						<button className="text-slate-400 hover:text-white">
							{simulationPanelOpen ? <ChevronDown size={18} /> : <ChevronUp size={18} />}
						</button>
					</div>
					...
					<div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 animate-fadeIn">
						<div className="bg-slate-800 rounded-lg shadow-xl w-4/5 max-w-5xl max-h-[90vh] flex flex-col border border-slate-700 animate-scaleIn">
							<div className="flex items-center justify-between border-b border-slate-700 p-4">
								<h2 className="text-xl font-bold text-white">Network Performance Metrics</h2>
								<button
							...
							<div className="p-6 overflow-y-auto">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									<div className="bg-slate-900 p-4 rounded-lg shadow-md">
										...
										<div className="h-64 bg-slate-800 rounded border border-slate-700 p-4">
											<MetricGraph metricName="latency" color="rgb(96, 165, 250)" title="Latency" icon={<Activity />} />
										</div>
									</div>
