		...
		<div className="h-full flex flex-col">
			<div className="flex-1 overflow-y-auto pr-2">
				{aiDecisions.length === 0 ? (
					<div className="text-center text-slate-500 py-8">No AI decisions recorded yet</div>
				) : (
					<div className="space-y-3">
						{aiDecisions.map((decision) => (
							<div key={decision.id} className="bg-slate-700 rounded-lg p-3 border-l-4 border-blue-500 animate-fadeIn">
